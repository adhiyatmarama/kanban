...
},{}],"components/task.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    deleteTask: function deleteTask(id) {
      ...
      swal({
        ...
        if (willDelete) {
          var options = {
            url: "".concat(_this.baseUrl, "/tasks/").concat(id),
            method: 'delete',
            headers: {
              token: localStorage.token
            }
          };
          (0, _axios.default)(options).then(function (_ref) {
            var data = _ref.data;
...
exports.default = _default;
        var $ac42e6 = exports.default || module.exports;
      
      if (typeof $ac42e6 === 'function') {
        $ac42e6 = $ac42e6.options;
      }
    
        /* template */
        Object.assign($ac42e6, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    {
      ...
      class: {
        "border-1": _vm.kelas.isBorder1,
        "border-2": _vm.kelas.isBorder2,
        "border-3": _vm.kelas.isBorder3,
        "border-4": _vm.kelas.isBorder4
      }
    },
    [
      _c("div", { staticClass: "task-content" }, [
        _c("div", { staticClass: "task-title" }, [
          _c("span", [_vm._v(_vm._s(_vm.task.title))])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "task-description" }, [
          _c("span", [_vm._v(_vm._s(_vm.task.description))])
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "action" }, [
        _c("i", {
          staticClass: "fa fa-trash btn-delete",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ac42e6', $ac42e6);
          } else {
            api.reload('$ac42e6', $ac42e6);
          }
        }
...
},{"axios":"../node_modules/axios/index.js","_css_loader":"../../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/category.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $4a6c54 = exports.default || module.exports;
      
      if (typeof $4a6c54 === 'function') {
        $4a6c54 = $4a6c54.options;
      }
    
        /* template */
        Object.assign($4a6c54, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    {
      class: {
        backlog: _vm.kelas.isBacklog,
        "border-1": _vm.kelas.isBorder1,
        todo: _vm.kelas.isTodos,
        "border-2": _vm.kelas.isBorder2,
        done: _vm.kelas.isDone,
        "border-3": _vm.kelas.isBorder3,
        completed: _vm.kelas.isCompleted,
        "border-4": _vm.kelas.isBorder4
      }
    },
    [
      ...
      _c(
        ...
        _vm._l(_vm.data, function(task) {
          return _c("task", {
            key: task.id,
            attrs: { task: task, kelas: _vm.kelas },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4a6c54', $4a6c54);
          } else {
            api.reload('$4a6c54', $4a6c54);
          }
        }
...
},{"./task":"components/task.vue","axios":"../node_modules/axios/index.js","_css_loader":"../../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/header.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $c88b2b = exports.default || module.exports;
      
      if (typeof $c88b2b === 'function') {
        $c88b2b = $c88b2b.options;
      }
    
        /* template */
        Object.assign($c88b2b, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    _c("div", { staticClass: "header-content" }, [
      ...
      !_vm.isLogin
        ? _c(
            ...
            [
              _c("ul", [
                _c("li", { on: { click: _vm.showLogin } }, [_vm._v("SIGN IN")]),
                _vm._v(" "),
                _c("li", { on: { click: _vm.showRegister } }, [
                  _vm._v("REGISTER")
                ])
              ])
            ]
      ...
      _vm.isLogin
        ? _c(
            ...
            [
              _c("ul", [
                _c("li", { on: { click: _vm.logout } }, [_vm._v("SIGN OUT")])
              ])
            ]
          )
        : _vm._e()
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      [_c("h2", { staticStyle: { "margin-top": "14px" } }, [_vm._v("KANBAN")])]
    )
  },
  function() {
    var _vm = this
    ...
    return _c(
      ...
      {
        staticClass: "navbar",
        staticStyle: { float: "left", "margin-top": "6px", display: "none" }
      },
      [
        _c("ul", [
          _c("li", [_vm._v("HOME")]),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c88b2b', $c88b2b);
          } else {
            api.reload('$c88b2b', $c88b2b);
          }
        }
...
var _default = {
  ...
  methods: {
    ...
    logIn: function logIn() {
      ...
      var options = {
        url: "".concat(this.baseUrl, "/user/login"),
        method: 'post',
        data: {
      ...
      (0, _axios.default)(options).then(function (_ref2) {
        ...
        _this2.logInError = '';
        _this2.logInError = err.response.data.msg;
      });
    },
    logout: function logout() {
    ...
    register: function register() {
      ...
      var options = {
        url: "".concat(this.baseUrl, "/user/register"),
        method: 'post',
        data: {
      ...
      (0, _axios.default)(options).then(function (_ref3) {
        var data = _ref3.data;
        ...
        if (err.response.data.error) {
          err.response.data.error.forEach(function (item) {
            _this3.registerError.push(item.msg);
          });
        } else {
          _this3.registerError.push(err.response.data.msg);
        }
      });
    },
    addTask: function addTask() {
      ...
      (0, _axios.default)(options).then(function (_ref4) {
        var data = _ref4.data;
        _this4.addTaskTitle = '';
        _this4.addTaskDesc = '';
        _this4.addTaskForm = false, _this4.addTaskError = '';

        _this4.getTasks();
      }).catch(function (err) {
        err.response.data.error.forEach(function (item) {
          _this4.addTaskError += "".concat(item.msg);
        });
      });
    },
    deleteTask: function deleteTask() {
  ...
  computed: {
    ...
    completeds: function completeds() {
      return this.tasks.filter(function (item) {
...
exports.default = _default;
        var $eeb865 = exports.default || module.exports;
      
      if (typeof $eeb865 === 'function') {
        $eeb865 = $eeb865.options;
      }
    
        /* template */
        Object.assign($eeb865, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    [
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("div", {
                          ...
                          staticStyle: { margin: "10px auto", width: "100px" },
                ...
                ? _c("div", { staticClass: "register" }, [
                    ...
                    _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _vm._l(_vm.registerError, function(item) {
                          return _c(
                            "p",
      ...
      _vm.isLogin
        ? _c("div", { staticClass: "main-page" }, [
            _c("h1", [
              _vm._v("Hello " + _vm._s(_vm.name) + ", This Is Your Kanban")
            ]),
            _vm._v(" "),
            _c(
              "div",
                    ...
                    _c("div", [
                      ...
                      _c(
                        ...
                        [
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.addTaskDesc,
                                expression: "addTaskDesc"
                              }
                            ],
                            attrs: { type: "text", placeholder: "Description" },
                            domProps: { value: _vm.addTaskDesc },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                                }
                                _vm.addTaskDesc = $event.target.value
                              }
                            }
                          }),
                          _c("br"),
                          ...
                          _vm.addTaskError
                            ? _c("p", { staticStyle: { color: "red" } }, [
                                _vm._v(_vm._s(_vm.addTaskError))
                              ])
                            : _vm._e()
                        ]
                      )
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "welcome" }, [
      ...
      _vm._v(" "),
      _c("h1", [_vm._v("KANBAN APPS")]),
      _vm._v(" "),
      _c("img", {
        staticStyle: { width: "80%", height: "auto" },
        attrs: { src: "/kids-holding-colorful-blocks-illustration_53876-40275.9aada84a.jpg" }
      })
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$eeb865', $eeb865);
          } else {
            api.reload('$eeb865', $eeb865);
          }
        }
...
},{"axios":"../node_modules/axios/index.js","./components/category":"components/category.vue","./components/header":"components/header.vue","./kids-holding-colorful-blocks-illustration_53876-40275.jpg":[["kids-holding-colorful-blocks-illustration_53876-40275.9aada84a.jpg","kids-holding-colorful-blocks-illustration_53876-40275.jpg"],"kids-holding-colorful-blocks-illustration_53876-40275.jpg"],"_css_loader":"../../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";
